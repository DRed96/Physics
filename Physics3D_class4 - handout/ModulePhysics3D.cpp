...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btPoint2PointConstraint*>* c_item = constraints.getFirst();
	while (c_item)
	{
		delete c_item->data;
		c_item = c_item->next;
...
btPoint2PointConstraint* ModulePhysics3D::Point2Constraint(PhysBody3D& rbA, PhysBody3D& rbB, const btVector3& pivotA, const btVector3& pivotB)
{
	btPoint2PointConstraint * ret = NULL;
	ret = new btPoint2PointConstraint(*rbA.body, *rbB.body, pivotA, pivotB);
	if (ret != NULL)
		constraints.add(ret);
	world->addConstraint(ret);
	return ret;
}
// ---------------------------------------------------------
